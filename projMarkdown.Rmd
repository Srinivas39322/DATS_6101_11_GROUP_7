...
ggplot(plot_data, aes(x = Year)) +
  geom_line(aes(y = Releases, color = "Releases"), linewidth = 1) +
  geom_line(aes(y = Updates, color = "Updates"), linewidth = 1, linetype = "dashed") +
  ...
  theme(legend.position = "top")+scale_x_continuous(breaks = seq(2008, 2022, 1))+
