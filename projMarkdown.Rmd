...
### Dropping the Developer_Website column
...
# Dropping blanks in the column "Released" 
...
### Updating Price and Size_Bytes column's NA values with mean
...
```
###Number of Games Released over years
```{r}
...
###Distribution of Reviews and Rating Over Years
```{r}
